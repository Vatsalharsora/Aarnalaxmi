...
// Optionally, logoWhite if needed, but not used in Theme 2.
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-16">
          <div className="md:col-span-4 lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-200 text-slate-500 hover:bg-brand-teal hover:text-white transition-all duration-300 shadow-sm hover:shadow-md">
          ...
          <div className="md:col-span-3 lg:col-span-3 lg:ml-auto">
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-slate-600 hover:text-brand-teal transition-colors flex items-center gap-3 font-medium"><svg className="w-4 h-4 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg> About Us</a></li>
              ...
              <li><a href="#" className="text-slate-600 hover:text-brand-teal transition-colors flex items-center gap-3 font-medium"><svg className="w-4 h-4 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg> Careers</a></li>
            </ul>
          </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group">
                  <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-brand-light text-brand-teal shrink-0 group-hover:bg-brand-teal group-hover:text-white transition-colors duration-300">
                ...
                <li className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@aarnalaxmi.com" className="text-brand-teal font-semibold hover:text-brand-gold transition-colors">contact@aarnalaxmi.com</a>
                  </div>
                </li>
                <li className="flex items-start gap-4 group">
                  <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-brand-light text-brand-teal shrink-0 group-hover:bg-brand-teal group-hover:text-white transition-colors duration-300">
